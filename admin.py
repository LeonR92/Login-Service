...
def add_user_to_yaml(username, password, role, yaml_file="config.yaml"):
...
if __name__ == "__main__":
    ...
    add_user_to_yaml(args.username, args.password, args.role, args.file)

# Run admin.py new_username new_password and role  to create a newuser